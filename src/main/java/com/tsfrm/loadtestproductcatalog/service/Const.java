...
public class Const {
    ...
    public static final String HEADER_PROVIDER_NAME = System.getenv("HEADER_PROVIDER_NAME") != null ? System.getenv("HEADER_PROVIDER_NAME") : "VDI_Staging_PT_new_v3"; //VERY IMPORTANT TO MODIFY
