...
public class Const {
    ...
    public static final String HEADER_PROVIDER_NAME = System.getenv("HEADER_PROVIDER_NAME") != null ? System.getenv("HEADER_PROVIDER_NAME") : "VDI_Staging_PT_v2"; //VERY IMPORTANT TO MODIFY
